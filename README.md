...
```
cd existing_repo
git remote add origin https://gitlab.aws.dev/skoppar/nova-citations.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.aws.dev/skoppar/nova-citations/-/settings/integrations)
